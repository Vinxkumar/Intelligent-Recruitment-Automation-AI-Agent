JOB_DESCRIPTION = """
    ...
    Job Post
    <A short linked-in style job post>
    ...
    https://intelligent-recruitment-automation-ai.onrender.com <always include this url at the end and dont include this statement in the ouptout>
