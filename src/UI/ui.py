...
class mainWindow:
    def __init__(self):
        ...
        self.fActiveButton = ctk.CTkButton (
            ...
            font=("Helvetica", 20),
            # fg_color="#94b8b4",
            command = lambda: ActiveDriveWindow(),
            corner_radius=15,
...
# def sendRequirements():
    # return Hiring_Requirements or "NA"


class ActiveDriveWindow:
    def __init__(self) -> None:
        ...
        self.driveHis = ctk.CTkToplevel(self.parent.mainwindow)
